...
img3 = cv2.imread("TALLER 2 (DEFINIR)/2.png", 0)  # Leemos la imagen
...
img4 = cv2.imread("TALLER 2 (DEFINIR)/2.png", 0)  # Leemos la imagen
...
img5 = cv2.imread("TALLER 2 (DEFINIR)/2.png",0)  # Leemos la imagen
...
img2 = cv2.imread("TALLER 2 (DEFINIR)/2.png", 0)  # Leemos la imagen
